...
if %RETRY_COUNT% lss %MAX_RETRIES% (
    ...
    if %ERRORLEVEL% equ 0 (
        ...
        if !RETRY_COUNT! equ %MAX_RETRIES% (
            echo WAARSCHUWING: Server niet bereikbaar na %MAX_RETRIES% pogingen. Mogelijke problemen bij opstarten.
        ) else (
...
:: Wacht een seconde en probeer een andere methode als backup
timeout /t 1 /nobreak >nul
explorer "http://localhost:3001"

echo.
echo SUCCES: Applicatie is volledig gestart!
echo ======================================================
