...
import { CommandResult } from '../../src/software/commands/command.types';
...
describe('CommandFactoryService', () => {
  ...
  describe('executeCorelDrawAction', () => {
    it('should call createRectangle for create_rectangle action', async () => {
      ...
      const action = 'create_rectangle';
      const params = { x: 100, y: 100, width: 200, height: 100 };
      corelCommandsService.createRectangle.mockResolvedValue({ success: true, code: 'Rectangle created' } as CommandResult);
    ...
    it('should call createEllipse for create_ellipse action', async () => {
      ...
      const params = { x: 100, y: 100, width: 200, height: 100 };
      corelCommandsService.createEllipse.mockResolvedValue({ success: true, code: 'Ellipse created' } as CommandResult);
  ...
  describe('executeBlenderAction', () => {
    it('should call createCube for create_cube action', async () => {
      ...
      const action = 'create_cube';
      const params = { location: [0, 0, 0], size: 2 };
      blenderCommandsService.createCube.mockResolvedValue({ success: true, code: 'Cube created' } as CommandResult);
    ...
    it('should call createSphere for create_sphere action', async () => {
      ...
      blenderCommandsService.createSphere.mockResolvedValue({ success: true, code: 'Sphere created' } as CommandResult);
  ...
  describe('getAvailableCommands', () => {
    ...
    it('should throw an error for unsupported platform', () => {
      // Act & Assert
      expect(() => service.getAvailableCommands('unsupported'))
