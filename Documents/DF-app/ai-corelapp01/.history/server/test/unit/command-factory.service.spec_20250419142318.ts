...
import { CorelCommandResult, BlenderCommandResult } from '../../src/software/commands/index';
...
// Type for platform
type SupportedPlatform = 'coreldraw' | 'blender';
...
describe('CommandFactoryService', () => {
  ...
  describe('executeCommand', () => {
    ...
    it('should throw an error for unsupported platform', async () => {
      // Arrange
      const platform = 'unsupported' as SupportedPlatform; // Type assertion
  ...
  describe('getAvailableCommands', () => {
    ...
    it('should throw an error for unsupported platform', () => {
      // Act & Assert
      expect(() => service.getAvailableCommands('unsupported' as SupportedPlatform))
