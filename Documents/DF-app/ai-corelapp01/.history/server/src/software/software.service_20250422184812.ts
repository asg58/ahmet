    ...
    try {
      ...
      if (options.intent) {
        ...
        return {
          ...
          message: result.success ? 'Commando succesvol uitgevoerd.' : 'Fout bij uitvoeren commando.',
      ...
      const contextInfo = context ? this.contextAwareQueryService.convertContextToText(context) : '';
      ...
      if (!parsed.action) {
        return {
          success: false,
          message: 'Kon geen actie afleiden uit het commando.',
      ...
      return {
        success: false,
        message: 'Fout bij uitvoeren commando.',
        error: error.message,
