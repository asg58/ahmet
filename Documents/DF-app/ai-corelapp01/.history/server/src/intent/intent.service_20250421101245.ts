...
export interface Intent {
  ...
  contextualReferences?: Array<string>;
...
export interface IntentDetectionOptions {
  ...
  useDomainRAG?: boolean;
  enhancedDesignContext?: boolean;
}
...
export class IntentService {
  ...
  constructor(
    ...
    private readonly enhancedContextQueryService: EnhancedContextQueryService
  ) {}
      ...
      prompt += `
{
  ...
  private async appendEnhancedDesignContext(prompt: ChatMessage[]): Promise<void> {
    try {
      ...
      const enhancedContextPrompt = await this.enhancedContextQueryService.buildEnhancedPrompt(
        '',  // No base prompt
        context,
