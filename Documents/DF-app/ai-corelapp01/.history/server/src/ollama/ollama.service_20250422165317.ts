...
export class OllamaService implements OnModuleInit {
  ...
  private taskToModelMap: Record<TaskType, string> = {
    [TaskType.CODE_GENERATION]: 'codellama:7b-code',
    [TaskType.CONTEXT_ANALYSIS]: 'llama3:8b',
    [TaskType.CREATIVE_CONTENT]: 'llama3:8b',
    [TaskType.QUICK_RESPONSE]: 'stable-code:3b-code-q4_0',
    [TaskType.MATH_REASONING]: 'codellama:7b-code',
    [TaskType.DEFAULT]: 'llama3:8b',
  };
