...
export class OllamaService implements OnModuleInit {
  ...
  async chatCompletion(request: ChatCompletionRequest) {
    try {
      ...
      // Use the older API with the /api/generate endpoint
      this.logger.debug(`Sending chat completion request to ${this.baseUrl}/api/generate with model ${request.model}`);
