...
export class OllamaService implements OnModuleInit {
  ...
  private taskToModelMap: Record<TaskType, string> = {
    [TaskType.CODE_GENERATION]: 'mistral:latest',
    [TaskType.CONTEXT_ANALYSIS]: 'mistral:latest',
    [TaskType.CREATIVE_CONTENT]: 'mistral:latest',
    [TaskType.QUICK_RESPONSE]: 'mistral:latest',
    [TaskType.MATH_REASONING]: 'mistral:latest',
    [TaskType.DEFAULT]: 'mistral:latest',
  };
