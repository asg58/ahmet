...
## 5. Eenvoudige context-tracking

### 5.1 Basis context capture
...
### 5.2 Eenvoudige context-aware adapter
...
- **Fase 4 (Basis context-tracking)**: 1-2 weken
- **Fase 5 (Testing, documentatie en demo)**: 1-2 weken
