...
### 2.2 OllamaConversationService bouwen
...
### 2.3 DesignContextAnalyzer ontwikkelen
...
### 3.1 IntentRecognitionSystem implementeren
- [ ] Open-ended natuurlijke taalinterpretatie bouwen
- [ ] Intentie-naar-actie mapping framework ontwikkelen
- [ ] Contextbewuste ontwerpterminologie herkenning
...
|--------|-------------------|--------|-------------------|
| Complexiteit van open-ended natuurlijke taalverwerking | Hoog | Hoog | Incrementele verbetering, focus op specifieke ontwerpdomein-termen |
