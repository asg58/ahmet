...
import { ContextAwareCommandAdapter as UniversalContextAwareAdapter } from './universal/context-aware-adapter';
...
import { ContextGatewayModule } from './context/context-gateway.module';
...
@Module({
  imports: [
    ...
    forwardRef(() => ContextGatewayModule),
  ],
  controllers: [
    SoftwareController,
