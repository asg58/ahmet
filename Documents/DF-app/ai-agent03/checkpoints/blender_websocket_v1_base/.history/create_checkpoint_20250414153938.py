...
def create_checkpoint(checkpoint_name=None):
    ...
    # Maak de checkpoints root directory als deze nog niet bestaat
    checkpoints_dir = os.path.join(os.getcwd(), "checkpoints")
    if not os.path.exists(checkpoints_dir):
        os.makedirs(checkpoints_dir)
        print(f"Checkpoints map aangemaakt: {checkpoints_dir}")
    
    # Maak de specifieke checkpoint directory
    ...
    for root, dirs, files in os.walk(os.getcwd()):
        # Sla de checkpoints directory zelf over
...
def restore_checkpoint(checkpoint_name):
    ...
    """
    # Check first in the checkpoints directory
    checkpoints_dir = os.path.join(os.getcwd(), "checkpoints")
    checkpoint_dir = os.path.join(checkpoints_dir, checkpoint_name)
    
    # If not found in checkpoints directory, check in root (backward compatibility)
    if not os.path.exists(checkpoint_dir):
...
def list_checkpoints():
    ...
    # Controleer de checkpoints directory
    checkpoints_dir = os.path.join(os.getcwd(), "checkpoints")
    ...
    # Controleer ook de root directory voor oudere checkpoints (backward compatibility)
